...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-6 form-group">
            ...
            <input type="number" required class="form-control" name="txtPrecioUni" id="txtPrecioUni" value="<?php echo $venta->preciounitario ?>">
        </div>
        <div class="col-6 form-group">
            <label for="txtCantidad">Cantidad:</label>
            <input type="text" required class="form-control" name="txtCantidad" id="txtCantidad" required value="<?php echo $venta->cantidad ?>" placeholder="0">
        </div>
        <div class="col-6 form-group">
            <label for="txtTotal">Total:</label>
            <input type="text" required class="form-control" name="txtTotal" id="txtTotal" required value="<?php echo $venta->preciounitario * ($venta->cantidad) ?>" placeholder="<?php echo $venta->preciounitario * ($venta->cantidad) ?>">
        </div>
